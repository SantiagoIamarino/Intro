...
<div class="post page-container">
  ...
  <div class="post-form">
    <form id='post_form' enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>"
      method='POST'>
      <div class="mb-3">
        <label for="title" class="form-label">Título del proyecto</label>
        <input type="text" class="form-control" name="title"
          value="<?php echo (isset($project['title'])) ? $project['title'] : '' ?>" id="title"
      ...
      <div class="row mb-3">
        <div class="col-12">
          ...
          <input type="text" class="form-control" name="location"
            value="<?php echo (isset($project['location'])) ? $project['location'] : '' ?>" id="location"
            placeholder="">
        </div>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-12 col-md-6">
          ...
          <input type="text" class="form-control" name="year"
            value="<?php echo (isset($project['year'])) ? $project['year'] : '' ?>" id="year"
        ...
        <div class="col-12 col-md-6">
          ...
          <input type="text" class="form-control" name="surface"
            value="<?php echo (isset($project['surface'])) ? $project['surface'] : '' ?>" id="surface"
            placeholder="Ejemplo: 2000 (solo número)">
        </div>
      </div>
      ...
      <div class="row mb-3">
        <div class="col-12 col-md-6">
          ...
          <input type="text" class="form-control" name="industry"
            value="<?php echo (isset($project['industry'])) ? $project['industry'] : '' ?>" id="industry"
            placeholder="Industria">
        </div>

        <div class="col-12 col-md-6">
          <label for="industry_en" class="form-label">Industria (Inglés)</label>
          <input type="text" class="form-control" name="industry_en"
            value="<?php echo (isset($project['industry_en'])) ? $project['industry_en'] : '' ?>" id="industry_en"
            placeholder="Industria (Inglés)">
        </div>
      ...
      <div class="mt-4 mb-3">
        <label for="en-text-editor" class="form-label">Contenido del proyecto (Inglés)</label>
        <div id="toolbar-container"></div>
      ...
      <div class="w-100 save-btn d-flex justify-content-center mt-4">
        ...
        <input type="hidden" name="last_title" value="<?php echo $project['title'] ?>">

        <input type="hidden" name="slug" value="<?php echo $project['slug'] ?>">

        <button class='save-btn' onclick='getProjectContent(event)' type='submit' name='postEdit'>
          <i class="bi bi-pencil"></i>
          Editar proyecto
        </button>

        <?php else: ?>
        <button onclick='getProjectContent(event)' type='submit' style='min-width: 300px' class='save-btn'
          name='postEdit'>
